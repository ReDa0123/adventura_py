...
#P:/p1_EDU/p1_Demos23s/game23s/a1a_happy/__init__.py
"""
Demonstrační balíček v němž je definován pouze scénář HAPPY.
"""
...
AUTHOR_NAME = 'HAPPY Scenario'

# Jméno autora/autorky programu ve formátu PŘÍJMENÍ Křestní
# zapsané v jeho/jejím rodném jazyce
AUTHOR_NATIVE_NAME = 'ŠŤASTNÝ Scénář'

# Čas začátku kroužku, který navštěvujete
GROUP_TIME = '0_0000'  # Zadejte čtyřčíslí odpovídající času začátku kroužku
...
def self_test():
    ...
    LEVEL = gt.Level.HAPPY  # Nastavení hladiny rozpracovanosti aplikace
...
# import game23s.a1a_happy as m; m.self_test()
